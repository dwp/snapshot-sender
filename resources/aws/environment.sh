...
subscribe_sns_to_sqs() {
    aws_local sns subscribe --topic-arn "http://aws:4566/000000000000/monitoring-topic" \
    --protocal "sqs" --notification-endpoint "http://aws:4566/000000000000/monitoring-queue"
}
